...
{
    public partial class TheEquipmentOperationLogProfilometer : System.Web.UI.Page
    {
        ...
        protected async void Button1_OnClick(object sender, EventArgs e)
        {
            ...
            SqlCommand regUser = new SqlCommand("INSERT INTO [ZYGO] (FullName, Phone, EMail, Time, Temperature, Pressure, Humidity, BlockNumber," +
                                                " SurfaceRoughnessIndex, RadiusOfCurvatureOfSphere)VALUES(@FullName, @Phone, @EMail, @Time, @Temperature, @Pressure, @Humidity, @BlockNumber, @SurfaceRoughnessIndex, @RadiusOfCurvatureOfSphere)", sqlConnection);
            ...
            regUser.Parameters.AddWithValue("SurfaceRoughnessIndex", TextBox9.Text);
            regUser.Parameters.AddWithValue("RadiusOfCurvatureOfSphere", TextBox10.Text);
