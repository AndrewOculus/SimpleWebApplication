<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="LogOfEquipmentOperationInterferometer.aspx.cs" Inherits="LasexWebFormApp.LogOfEquipmentOperationInterferometer" %>
        ...
        <div>
            ...
            <asp:TableRow> 
                <asp:TableCell ColumnSpan="2">
                    <asp:Label ID="Label15" runat="server" Text="Журнал эксплуатации оборудования (интерферометр OptoTL-250 ЕТВС.58901205)"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label ID="Label9" runat="server" Text="Число интерференционных колец"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
