<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="TheEquipmentOperationLogProfilometer.aspx.cs" Inherits="LasexWebFormApp.TheEquipmentOperationLogProfilometer" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Table ID="Table1" runat="server" Width="889px" Height="594px">
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Label ID="Label9" runat="server" Text="Показатель шероховатости поверхности"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Label ID="Label10" runat="server" Text="Радиус кривизны сферы"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell>
