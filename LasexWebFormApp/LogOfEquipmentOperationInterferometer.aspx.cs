...
{
    public partial class LogOfEquipmentOperationInterferometer : System.Web.UI.Page
    {
        ...
        protected async void Button1_OnClick(object sender, EventArgs e)
        {
            ...
            SqlCommand regUser = new SqlCommand("INSERT INTO [OptoTL-250] (FullName, Phone, EMail, Time, Temperature, Pressure, Humidity, BlockNumber," +
                                                " NumberOfInterferenceRings)VALUES(@FullName, @Phone, @EMail, @Time, @Temperature, @Pressure, @Humidity, @BlockNumber, @NumberOfInterferenceRings)", sqlConnection);
            ...
            regUser.Parameters.AddWithValue("NumberOfInterferenceRings", TextBox9.Text);
